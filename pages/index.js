    ...
    <div className="content-container h-screen">
      ...
      <TopNavigation title = 'Homepage' />
        ...
        <div className="content-list">
          ...
          >
            <h3 className="post-owner text-2xl font-bold">Documentation &rarr;</h3>
          ...
          <a
            ...
            className="border-custom"
          >
            <h3 className="post-owner post-owner text-2xl font-bold">Examples &rarr;</h3>
            <p className="post-text">
      ...
      <footer className="flex items-center justify-center w-full h-24 border-t text-gray-800 dark:text-white whitespace-normal">
          ...
          <a className='flex items-center justify-center ' href='https://github.com/mercyfulsin' target="_blank" rel="noopener noreferrer">Mercyfulsin</a>
      </footer>
    </div>
  )
}
